...
def CreateOptimizationAlgorithm(optimization_settings, analyzer, communicator, model_part_controller):
    ...
    elif algorithm_name == "steepest_descent_initial_filtering":
        from .algorithm_steepest_descent_initial_filtering import AlgorithmSteepestDescentInitialFiltering
        return AlgorithmSteepestDescentInitialFiltering(optimization_settings,
                                                        analyzer,
                                                        communicator,
                                                        model_part_controller)
