...
class AlgorithmSteepestDescentInitialFiltering(OptimizationAlgorithm):
    ...
    def __init__(self, optimization_settings, analyzer, communicator, model_part_controller):
        ...
        self.rho = self.algorithm_settings["line_search"]["armijo_parameters"]["rho"].GetDouble()
        self.eta = self.algorithm_settings["line_search"]["armijo_parameters"]["eta"].GetDouble()
        self.max_iterations_armijo = self.algorithm_settings["line_search"]["armijo_parameters"]["max_iterations"].GetInt()
        ...
        # Create and configure the initial model part controller
    ...
    def InitializeOptimizationLoop(self):
        ...
        # Create and initialize the initial_mapper
    ...
    def __analyzeShape(self):
        #Calculate value and gradient(DF1DX) of response = "strain_energy" on current model part
        ...
        #Damp nodal sensitivity variable on initial_model_part_controller
        self.initial_model_part_controller.DampNodalSensitivityVariableIfSpecified(KSO.DF1DX)
    ...
    def __computeShapeUpdate(self):
        ...
        #Copy DF1DX_MAPPED(control field Xs) to current model for visualization
        ...
        #Compute the control point update (step size adjustment)
        ...
        #Save shape change into a vector
        ...
        #Map the control point change (control field Xs) to the shape change variable (physical design surface X) - initial model part
        ...
        #Save shape change into a vector - current
        shape_change = KM.Vector() 
        self.optimization_utilities.AssembleVector(self.design_surface, shape_change, KSO.SHAPE_CHANGE)
        
        #Compute the difference between the new and previous shape changes (shape update)
