...
namespace Kratos
{
	...
	KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF1DX_LINE_SEARCH);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DF1DX_LINE_SEARCH_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(SEARCH_DIRECTION_LINE_SEARCH);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        //Temporary storage for gradient data during line search computations
	    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF1DX_LINE_SEARCH);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DF1DX_LINE_SEARCH_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(SEARCH_DIRECTION_LINE_SEARCH);
