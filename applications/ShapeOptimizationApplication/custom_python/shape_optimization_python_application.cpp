...
PYBIND11_MODULE(KratosShapeOptimizationApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DF1DX_LINE_SEARCH);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, DF1DX_LINE_SEARCH_MAPPED);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(m, SEARCH_DIRECTION_LINE_SEARCH);
